...
<head>
    ...
    <meta name="author" content="yaser.darzi@gmail.com">
    ...
    <link href="{{ asset('admin/fonts/simple-line-icons-master/css/simple-line-icons.css') }}" rel="stylesheet">

    <!-- Main styles for this application -->
    <link href="{{ asset('admin/css/style.css') }}" rel="stylesheet">
    <!-- Main styles for this application -->
    <link href="{{ asset('web/css/arasico.css') }}" rel="stylesheet">
...
<div class="app-body">
    <div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{url('')}}"><i class="icon-speedometer"></i> view site </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('dashboard/activeAds')}}"><i class="fa fa-check "></i>Tead agahi</a>
                </li>

                <li class="nav-item nav-dropdown">
                    <a class="nav-link nav-dropdown-toggle" href="#"><i class="fa fa-bullhorn "></i> Advertisement</a>
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('dashboard/advertisement/create')}}"><i
                                        class="icon-star"></i>
                                Add Advertisement</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('dashboard/advertisement')}}"><i class="icon-list"></i> List
                                Advertisement</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item nav-dropdown">
                    <a class="nav-link nav-dropdown-toggle" href="#"><i class=" fa fa-gear "></i> Setting</a>
...
<footer class="app-footer">
    <span><a href="http://didikojast.ir">didiKojast</a> © 2017</span>
</footer>
